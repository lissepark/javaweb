					...
					<tr>
						...
						<td style="padding: 50px 0 0 30px" valign="top">
                            <table style="width: 450px" cellpadding="0" cellspacing="0">
								<tr align="right">
									<td width="160px" style="font-size: larger; font-weight: 700;">
                                        Выбрать семестр
                                    </td>
									<td style="padding-left: 10px">
                                        <select id="opening_list" style="width: 160px" name="chooser">
									...
									<td style="padding-left: 10px">
                                        <input type="submit" value="Выбрать" id="button" style="width: 100px"></td>
								</tr>
