	...
	<table>
		...
		<tr>
			<td style="padding-top: 20px">
                <input type="submit" value="Модифицировать выбранного студетна..."
                       id="button_long_name" name="modifying" onclick="modifyingStudent()">
            </td>

			<td style="padding-left: 20px; padding-top: 20px">
                <input type="button" onclick="deleteStudents()" name="delete"
				value="Удалить выбранных студентов" id="button_short_name">
            </td>
		</tr>
		</c:if>
	</table>
		...
		<tr>
			<td><table border="2" cellspacing="0" cellpadding="4"
					...
					<c:forEach var="student" items="${students }">
						<tr valign="bottom">
							<td height="80px" style="padding-bottom: 20px" align="center">
                                <input type="checkbox" id="${student.id }"></td>
							<td style="padding-bottom: 20px">${student.name }</td>
							<td style="padding-bottom: 20px">${student.second_name }</td>
